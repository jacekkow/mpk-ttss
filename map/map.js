...
function setRouteTarget(vehicle) {
    var location = (vehicle.latitude / 3600000.0) + "," + (vehicle.longitude / 3600000.0);
    routeModule.setTarget(location);
}
...
function init() {
    ...
    routeModule = new document.RouteModule(route_source);
